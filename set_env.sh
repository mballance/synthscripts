#****************************************************************************
#* synthscripts set_env.sh
#****************************************************************************

if test "x$SIMSCRIPTS_DIR" = "x"; then
  echo "Error: synthscripts require simscripts to be setup first"
elif test ! -d $SIMSCRIPTS_DIR; then
  echo "Error: SIMSCRIPTS_DIR ($SIMSCRIPTS_DIR) does not exist"
else
