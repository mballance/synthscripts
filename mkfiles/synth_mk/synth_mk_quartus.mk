...
SIM_COMPILE_TARGETS += $(TOP_MODULE).qpf 
SIM_POSTCOMPILE_TARGETS += $(TOP_MODULE).map $(TOP_MODULE).fit $(TOP_MODULE).sta $(TOP_MODULE).sim

IMG_COMPILE_TARGETS += $(TOP_MODULE).qpf 
IMG_POSTCOMPILE_TARGETS += $(TOP_MODULE).map $(TOP_MODULE).fit $(TOP_MODULE).sta $(TOP_MODULE).sof $(TOP_MODULE).rbf
